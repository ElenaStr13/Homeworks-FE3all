...
SELECT * FROM product WHERE brand="Apple" ORDER BY price;
SELECT * FROM product WHERE brand="Apple" ORDER BY price DESC;
SELECT * FROM product WHERE brand="Apple" ORDER BY category, price DESC;
SELECT * FROM product WHERE brand="Apple" ORDER BY category DESC, price DESC;
SELECT * FROM product WHERE brand="Apple" ORDER BY category, CASE WHEN category='smartphones' THEN price ELSE rating END;
SELECT * FROM product WHERE brand="Apple" ORDER BY category DESC, CASE WHEN category='smartphones' THEN price END DESC, CASE WHEN category='laptops' THEN price END;
...
SELECT COUNT(title) FROM product;
...
SELECT category AS type, COUNT(title) AS "Products quantity" FROM product GROUP BY category;
...
SELECT name, title, price FROM customer JOIN product ON customer.productID=product.id;
\! cls